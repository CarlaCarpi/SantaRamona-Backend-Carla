...
namespace SantaRamona.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        // =======================
        // ⭐ Helper Capitalizar por ORACIONES 
        // =======================
        ...
        public async Task<ActionResult<Persona>> Create([FromBody] Persona dto)
        {
            ...
            // motivoEgreso es más tipo "historia", lo tratamos como oración:
            dto.motivoEgreso = CapitalizarOraciones(dto.motivoEgreso);
        ...
        public async Task<IActionResult> Update(int id, [FromBody] Persona dto)
        {
            ...
            // motivoEgreso lo capitalizamos por oraciones
            dto.motivoEgreso = CapitalizarOraciones(dto.motivoEgreso);
